    ...
    <>
      ...
      <Section>
        ...
        <div class="max-w-4xl mx-auto">
          <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">We audit your site. <span class="text-primary">Then we tell you what to fix.</span></h1>
          <p class="text-xl text-dark-300 mb-16">AI specialists analyze your site and provide expert recommendations. You review and implement. That's it.</p>
        </div>
      </Section>

      <Section dark={false}>
        <div class="max-w-4xl mx-auto space-y-16">
          <StepCard number={1} title="Purchase your audit" description="Choose a one-time audit or subscribe for recurring audits. Payment is secure via Stripe. No setup required." />
          <StepCard number={2} title="AI specialists analyze" description="AI agents crawl your website, analyze your Google Business Profile, evaluate your content for AI answer optimization, and generate scores for SEO, GEO, and AEO. Time: 2-5 minutes." />
          <StepCard number={3} title="Get your report" description="Receive a detailed PDF audit report with scored findings and prioritized, actionable recommendations. Each issue explains the problem and provides specific guidance on how to fix it." />
          <StepCard number={4} title="Implement and improve" description="Use the recommendations to fix issues. Run follow-up audits to see your scores improve. Track your progress over time with recurring audits." />
        </div>
      </Section>
      ...
      <Section>
        <div class="max-w-4xl mx-auto">
          <h2 class="text-2xl font-bold text-white text-center mb-8">Other tools: "Here's what's wrong." <span class="text-primary">Sivussa: "Here's what to do."</span></h2>
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="text-dark-200">
                {[
                  ...
                  ['Specific guidance for your site', 'Sometimes generic', 'Tailored to your content'],
                  ['Content suggestions', 'No', 'AI-generated for your niche'],
                  ['Schema markup guidance', '"You should add it"', 'Explained with examples'],
      ...
      <Section dark={false}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            { title: 'Performance analysis', desc: 'Core Web Vitals and performance metrics.' },
            { title: 'PDF report', desc: 'Delivered to your email. Share with your team.' },
            { title: 'Recurring audits', desc: 'Monthly or quarterly audits for subscribers.' },
            { title: 'Track progress', desc: 'See your scores improve over time.' },
            { title: 'Email delivery', desc: 'Reports delivered directly to your inbox.' },
          ].map((t, i) => (
