    ...
    <>
      ...
      <Section>
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <p class="text-lg text-dark-300">Everything you need to know about Sivussa. Can't find your answer? Email <a href="mailto:sivussa@sivussa.com" class="text-primary hover:underline">sivussa@sivussa.com</a>.</p>
        </div>
      </Section>
        ...
        return (
          <Section key={cat} dark={cat === 'General' || cat === 'How It Works'}>
            <div class="max-w-3xl mx-auto">
              ...
              {items.map((item, i) => (
                <Accordion key={i} question={item.question} answer={item.answer} defaultOpen={i === 0} />
              ))}
            </div>
          </Section>
        );
      ...
      <Section>
        <div class="max-w-3xl mx-auto text-center">
          <p class="text-dark-300">Still have questions? <a href="mailto:sivussa@sivussa.com" class="text-primary hover:underline">sivussa@sivussa.com</a>. We respond within 24 hours.</p>
        </div>
      </Section>
    </>
  );
