...
declare module 'virtual:content' {
  ...
  export const PRIVACY_POLICY: { title: string; html: string };
  export const TERMS_OF_SERVICE: { title: string; html: string };
  export const OPEN_SOURCE_NOTICES: { title: string; html: string };
}
